public class Day2GitGithub {
    ...
    klasorumuzun icindeki dosyalari iliskilendirmek icin kullanılır
    ...
    5-) git push ---> uzak repo'ya (yani Github) gondermek icin kullandigimiz kod
    Yalniz git push komutunu direkt kullanmak istersek 1 kez

             git remote add origin adres (uzaga orijinal olarak su adresi ekle demek)
